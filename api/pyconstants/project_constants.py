...
LANGUAGE_TO_MODULE_SEARCH_ENV_VAR = {
    PYTHON_36_TEMPORAL_RUNTIME_PRETTY_NAME: "PYTHONPATH",
    NODEJS_10_TEMPORAL_RUNTIME_PRETTY_NAME: "NODE_PATH"
}

CONTAINER_RUNTIME_PATH = "/var/runtime"
