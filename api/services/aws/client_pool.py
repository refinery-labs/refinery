...
def get_aws_client_pool_deps( app_config ):
	...
	return dict(
		aws_sts_client=aws_sts_client,

	)

class AWSClientPool:
	def __init__( self, app_config, aws_sts_client ):
		"""
		...
		self.sts_client = aws_sts_client
		...
		"""
		self.client_cache = ExpiringDict(
			max_len=500,
	...
	def get_aws_client( self, client_type, credentials ):
		...
		self.client_cache[ cache_key ] = boto3_client
