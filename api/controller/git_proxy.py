...
# TODO: need to move away from inheriting from BaseHandler,
#  this messes up more restrictive CORS that we want for the proxy
class GitProxy( BaseHandler ):
    ...
    def is_pull_or_push( self ):
        ...
        is_push = content_type == 'application/x-git-upload-pack-request' and self.request.path.endswith('git-upload-pack')
        is_pull = content_type == 'application/x-git-receive-pack-request' and self.request.path.endswith('git-receive-pack')
