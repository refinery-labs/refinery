...
sed -i 's/https:\/\/d3asw1bke2pwdg.cloudfront.net\/manifest.json/\/manifest\/manifest.json/g' front-end-dist/index.html
sed -i 's/https:\/\/d3asw1bke2pwdg.cloudfront.net\/precache-manifest/\/manifest\/precache-manifest/g' front-end-dist/service-worker.js
