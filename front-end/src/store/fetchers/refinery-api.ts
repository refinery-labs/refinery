...
export class RefineryApi implements RefineryApiTypeMap {
  [API_ENDPOINT.HealthHandler] = makeApiClient<
    HealthCheckRequest,
    HealthCheckResponse
  ...
  [API_ENDPOINT.NewRegistration] = makeApiClient<
    NewRegistrationRequest,
    NewRegistrationResponse
  >(API_ENDPOINT.NewRegistration);
  [API_ENDPOINT.Login] = makeApiClient<LoginRequest, LoginResponse>(
    API_ENDPOINT.Login
  );
  [API_ENDPOINT.Logout] = makeApiClient<LogoutRequest, LogoutResponse>(
    API_ENDPOINT.Logout
  );
  [API_ENDPOINT.CreateSQSQueueTrigger] = makeApiClient<
    CreateSQSQueueTriggerRequest,
    CreateSQSQueueTriggerResponse
  >(API_ENDPOINT.CreateSQSQueueTrigger);
  [API_ENDPOINT.CreateScheduleTrigger] = makeApiClient<
    CreateScheduleTriggerRequest,
    CreateScheduleTriggerResponse
  ...
  [API_ENDPOINT.DeleteSavedProject] = makeApiClient<
    DeleteSavedProjectRequest,
    DeleteSavedProjectResponse
  >(API_ENDPOINT.DeleteSavedProject);
  [API_ENDPOINT.DeployDiagram] = makeApiClient<
    DeployDiagramRequest,
    DeployDiagramResponse
  ...
  [API_ENDPOINT.GetProjectConfig] = makeApiClient<
    GetProjectConfigRequest,
    GetProjectConfigResponse
  ...
  [API_ENDPOINT.GetProjectExecutions] = makeApiClient<
    GetProjectExecutionsRequest,
    GetProjectExecutionsResponse
  >(API_ENDPOINT.GetProjectExecutions);
  [API_ENDPOINT.GetSavedProject] = makeApiClient<
    GetSavedProjectRequest,
    GetSavedProjectResponse
  >(API_ENDPOINT.GetSavedProject);
  [API_ENDPOINT.InfraCollisionCheck] = makeApiClient<
    InfraCollisionCheckRequest,
    InfraCollisionCheckResponse
  >(API_ENDPOINT.InfraCollisionCheck);
  [API_ENDPOINT.InfraTearDown] = makeApiClient<
    InfraTearDownRequest,
    InfraTearDownResponse
  >(API_ENDPOINT.InfraTearDown);
  [API_ENDPOINT.RunLambda] = makeApiClient<RunLambdaRequest, RunLambdaResponse>(
    API_ENDPOINT.RunLambda
  );
  [API_ENDPOINT.RunTmpLambda] = makeApiClient<
    RunTmpLambdaRequest,
    RunTmpLambdaResponse
  >(API_ENDPOINT.RunTmpLambda);
  [API_ENDPOINT.SaveProject] = makeApiClient<
    SaveProjectRequest,
    SaveProjectResponse
  >(API_ENDPOINT.SaveProject);
  [API_ENDPOINT.SavedLambdaCreate] = makeApiClient<
    SavedLambdaCreateRequest,
    SavedLambdaCreateResponse
  >(API_ENDPOINT.SavedLambdaCreate);
  [API_ENDPOINT.SavedLambdaDelete] = makeApiClient<
    SavedLambdaDeleteRequest,
    SavedLambdaDeleteResponse
  >(API_ENDPOINT.SavedLambdaDelete);
  [API_ENDPOINT.SavedLambdaSearch] = makeApiClient<
    SavedLambdaSearchRequest,
    SavedLambdaSearchResponse
  >(API_ENDPOINT.SavedLambdaSearch);
  [API_ENDPOINT.SearchSavedProjects] = makeApiClient<
    SearchSavedProjectsRequest,
    SearchSavedProjectsResponse
...
export const getApiClient = <T extends API_ENDPOINT>(t: T): RefineryApiMap[T] =>
  apiClientMap[t];

export async function makeApiRequest<
  TReq extends BaseApiRequest,
  TRes extends BaseApiResponse
>(type: API_ENDPOINT, request: TReq) {
