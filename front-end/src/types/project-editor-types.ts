...
export const languageToAceLangMap: MonacoLanguageLookup = {
  ...
  [SupportedLanguage.NODEJS_10_TEMPORAL]: 'javascript',
...
export const LanguageToBaseRepoURLMap: LanguageToBaseRepoURL = {
  ...
  [SupportedLanguage.NODEJS_10_TEMPORAL]: 'https://www.npmjs.com',
...
export const LanguageToLibraryRepoURLMap: LanguageToLibraryRepoURL = {
  ...
  [SupportedLanguage.NODEJS_10_TEMPORAL]: LanguageToBaseRepoURLMap[SupportedLanguage.NODEJS_10_TEMPORAL] + '/package',
