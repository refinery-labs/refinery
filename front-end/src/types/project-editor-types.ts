...
export const languageToAceLangMap: MonacoLanguageLookup = {
  ...
  [SupportedLanguage.PYTHON_36]: 'python',
  [SupportedLanguage.PYTHON_38]: 'python',
...
export const LanguageToBaseRepoURLMap: LanguageToBaseRepoURL = {
  ...
  [SupportedLanguage.PYTHON_36]: 'https://pypi.org',
  [SupportedLanguage.PYTHON_38]: 'https://pypi.org',
...
export const LanguageToLibraryRepoURLMap: LanguageToLibraryRepoURL = {
  ...
  [SupportedLanguage.PYTHON_38]: LanguageToBaseRepoURLMap[SupportedLanguage.PYTHON_38] + '/project/',
  [SupportedLanguage.PYTHON_36]: LanguageToBaseRepoURLMap[SupportedLanguage.PYTHON_36] + '/project/',
