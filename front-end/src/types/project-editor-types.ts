...
export const languageToAceLangMap: MonacoLanguageLookup = {
  ...
  [SupportedLanguage.NODEJS_12_TEMPORAL]: 'javascript',
...
export const LanguageToBaseRepoURLMap: LanguageToBaseRepoURL = {
  ...
  [SupportedLanguage.NODEJS_12_TEMPORAL]: 'https://www.npmjs.com',
...
export const LanguageToLibraryRepoURLMap: LanguageToLibraryRepoURL = {
  ...
  [SupportedLanguage.NODEJS_12_TEMPORAL]: LanguageToBaseRepoURLMap[SupportedLanguage.NODEJS_12_TEMPORAL] + '/package',
