...
export default class RegistrationPage extends Vue {
    ...
    public renderLoginForm() {
        ...
        const emailInputErrorMessage = this.registrationEmailErrorMessage
                  ...
                  <span class="input-group-text text-muted bg-transparent border-left-0">
                    <em class="fa fa-users"/>
                        ...
                        <b-form-group id="stripe-payment">
                          ...
                          <small class="text-muted d-block">For more information about our pricing, see our <a href="#" target="_blank">Pricing page</a>.</small>
                        </b-form-group>
                    ...
                    <router-link class="btn btn-block btn-secondary" to="/login">Login</router-link>
                </b-card>
