...
export default class RegistrationPage extends Vue {
  ...
  registrationEmailInputValid: boolean | null = null;
  registrationNameInputValid: boolean | null = null;
  registrationOrgNameInputValid: boolean | null = null;
  registrationPaymentCardInputValid: boolean | null = null;
  termsAndConditionsAgreedValid: boolean | null = null;

  registrationErrorMessage: string | null = null;
  registrationSuccessMessage: string | null = null;
  registrationEmailErrorMessage: string | null = null;

  isBusy!: boolean;
  autoRefreshJobRunning!: boolean;

  setRegisterEmailInputValue(value: string) {
    this.registrationEmailErrorMessage = null;
    this.registrationEmailInputValid = validator.isEmail(value);
    this.registrationEmailInput = value;
  }

  setRegistrationStripeToken(value: string) {
    this.registrationPaymentCardInputValid = true;
    this.registrationStripeToken = value;
  }

  setRegisterNameInputValue(value: string) {
    this.registrationNameInputValid = value === '' || nameRegex.test(value);
    this.registrationNameInput = value;
  }

  setRegisterPhoneInputValue(value: string) {
    this.registrationPhoneInput = value;
  }

  setRegisterOrgNameInputValue(value: string) {
    this.registrationOrgNameInputValid = true;
    this.registrationOrgNameInput = value;
  }

  setAgreeToTermsValue(value: boolean) {
    this.termsAndConditionsAgreedValid = value;
