            ...
            <div class="card-body text-align--left">
              <div class="col-xl-6">
                <div class="card card-default" v-bind:class="{ 'whirl standard': isLoading }">
                  <div class="card-header">
                    Payment Methods<div class="card-tool float-right" v-on:click="getCards"><em class="fas fa-sync"></em></div>
                  </div>
                          ...
                          <div class="media align-items-center">
                            <div class="media-body d-flex">
                              ...
                              <div class="billing-buttons-column align-items-right">
                                <button v-if="!paymentMethod.is_primary" type="button" class="btn btn-primary billing-button" v-on:click="makePrimaryCard(paymentMethod)">
                                  <span class="fas fa-check-circle"></span> Make Primary
                                </button>
                                <button v-if="!paymentMethod.is_primary" type="button" class="btn btn-danger billing-button" v-on:click="deleteCard(paymentMethod)">
                  ...
                  <div class="card-footer">
                    <div class="d-flex">
                      <StripeAddPaymentCard registrationNameInput="" setRegistrationStripeTokenValue="setRegistrationStripeTokenValue"/>
                    </div>
                  </div>
                </div>
              </div>
...
<script lang="ts">
  ...
  export default class Billing extends Vue {
    ...
    @billing.Action setRegistrationStripeTokenValue!: (paymentMethodId: string) => void;
