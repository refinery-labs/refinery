          ...
          <Split props={{ direction: 'vertical' as Object }}>
            <SplitArea props={{ size: 40 as Object }}>
              <b-tabs nav-class="nav-justified" content-class="padding--none position--relative flex-grow--1">
                <b-tab title="Input Data" active={true}>
                  <div class="display--flex flex-grow--1 ace-hack">{renderEditorWrapper(null, inputDataEditor)}</div>
                </b-tab>
                <b-tab title="Backpack Data">
                  <div class="display--flex flex-grow--1 ace-hack">{renderEditorWrapper(null, backpackDataEditor)}</div>
                </b-tab>
              </b-tabs>
            </SplitArea>
